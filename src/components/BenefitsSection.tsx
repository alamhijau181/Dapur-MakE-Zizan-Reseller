...
export default function BenefitsSection() {
  return (
    <section id="benefits" className="py-24 bg-black border-b border-brand-muted relative overflow-hidden">
      {/* Background flare */}
      <div className="absolute top-1/2 right-10 -translate-y-1/2 w-80 h-80 bg-brand-orange/5 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-12 p-8 sm:p-10 rounded-3xl bg-brand-card border border-brand-border-light shadow-2xl relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-orange/[0.02] rounded-full blur-3xl pointer-events-none"></div>
